...
def gen_meta_code(title, extra="", bits=64):
    ...
    :param int bits: Bit-length of Meta-Hash.
...
def hash_meta_v0(title, extra="", ngram_size=META_NGRAM_SIZE):
    ...
    :param str title: Title of the work manifested in the digital asset.
    :param str extra: Optional additional text for disambiguation of the work.
    :param int ngram_size: Number of characters used for sliding tokenization (ngram).
    :return: 256-bit simhash byte digest for Meta-Code.
    :rtype: bytes
    """
    title = title.lower()
